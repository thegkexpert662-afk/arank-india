...
class MathsQuestionsScreen extends StatefulWidget {
  const MathsQuestionsScreen({super.key});

  @override
  State<MathsQuestionsScreen> createState() =>
      _MathsQuestionsScreenState();
}

class _MathsQuestionsScreenState
    extends State<MathsQuestionsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Maths With Explanation"),
        centerTitle: true,
      ),
      body: Column(
        children: [
