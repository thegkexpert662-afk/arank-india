...
class SscGdQuestionsScreen extends StatefulWidget {
  const SscGdQuestionsScreen({super.key});

  @override
  State<SscGdQuestionsScreen> createState() =>
      _SscGdQuestionsScreenState();
}

class _SscGdQuestionsScreenState
    extends State<SscGdQuestionsScreen> {
