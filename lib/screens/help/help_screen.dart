    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          final displayedAppId = (data['appId'] ?? appId ?? 'Not configured').toString();
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _InfoRow(label: 'Admin Name', value: adminName),
                    const SizedBox(height: 8),
                    _InfoRow(label: 'Admin App ID', value: displayedAppId),
                    const SizedBox(height: 8),
